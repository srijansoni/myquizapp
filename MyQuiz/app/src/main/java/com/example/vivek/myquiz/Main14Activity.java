...
Button b,c;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b= (Button) findViewById(R.id.n14);
        c= (Button) findViewById(R.id.ba14);
        t1= (TextView) findViewById(R.id.a14a);
        t2= (TextView) findViewById(R.id.a14b);
        t3= (TextView) findViewById(R.id.a14c);
        t4= (TextView) findViewById(R.id.a14d);
        ...
        t1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Main14Activity.this,"Tough Luck",Toast.LENGTH_SHORT).show();
                t2.setBackgroundResource(R.drawable.shape);
                t3.setBackgroundResource(R.drawable.shape);
                t4.setBackgroundResource(R.drawable.shape);
            }
        ...
        t3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Main14Activity.this,"Well Done",Toast.LENGTH_SHORT).show();
                t1.setBackgroundResource(R.drawable.shape);
                t2.setBackgroundResource(R.drawable.shape);
                t4.setBackgroundResource(R.drawable.shape);
            }
