...
Button b,c;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b= (Button) findViewById(R.id.n7);
        c= (Button) findViewById(R.id.ba7);
        t1= (TextView) findViewById(R.id.a7a);
        t2= (TextView) findViewById(R.id.a7b);
        t3= (TextView) findViewById(R.id.a7c);
        t4= (TextView) findViewById(R.id.a7d);
        ...
        t1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Main7Activity.this,"Tough Luck",Toast.LENGTH_SHORT).show();
                t2.setBackgroundResource(R.drawable.shape);
                t3.setBackgroundResource(R.drawable.shape);
                t4.setBackgroundResource(R.drawable.shape);
            }
        ...
        t4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Main7Activity.this,"Well Done",Toast.LENGTH_SHORT).show();
                t1.setBackgroundResource(R.drawable.shape);
                t2.setBackgroundResource(R.drawable.shape);
                t3.setBackgroundResource(R.drawable.shape);
            }
