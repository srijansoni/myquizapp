...
Button b,c;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b= (Button) findViewById(R.id.n12);
        c= (Button) findViewById(R.id.ba12);
        t1= (TextView) findViewById(R.id.a12a);
        t2= (TextView) findViewById(R.id.a12b);
        t3= (TextView) findViewById(R.id.a12c);
        t4= (TextView) findViewById(R.id.a12d);
        ...
        t1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Main12Activity.this,"Well Done",Toast.LENGTH_SHORT).show();
                t2.setBackgroundResource(R.drawable.shape);
                t3.setBackgroundResource(R.drawable.shape);
                t4.setBackgroundResource(R.drawable.shape);
            }
        ...
        t2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Main12Activity.this,"Tough Luck",Toast.LENGTH_SHORT).show();
                t1.setBackgroundResource(R.drawable.shape);
                t3.setBackgroundResource(R.drawable.shape);
                t4.setBackgroundResource(R.drawable.shape);
            }
