...
public class Main4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b= (Button) findViewById(R.id.n4);
        c= (Button) findViewById(R.id.ba4);
        t1= (TextView) findViewById(R.id.a4a);
        t2= (TextView) findViewById(R.id.a4b);
        t3= (TextView) findViewById(R.id.a4c);
        t4= (TextView) findViewById(R.id.a4d);
        ...
        t1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Main4Activity.this,"Tough Luck",Toast.LENGTH_SHORT).show();
                t2.setBackgroundResource(R.drawable.shape);
                t3.setBackgroundResource(R.drawable.shape);
                t4.setBackgroundResource(R.drawable.shape);
            }
        ...
        t2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Main4Activity.this,"Well Done",Toast.LENGTH_SHORT).show();
                t1.setBackgroundResource(R.drawable.shape);
                t3.setBackgroundResource(R.drawable.shape);
                t4.setBackgroundResource(R.drawable.shape);
            }
